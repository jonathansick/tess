...
PACKAGENAME = 'tess'
DESCRIPTION = 'Tessellation and image segmentation tools for astronomy'
LONG_DESCRIPTION = ''
AUTHOR = 'Jonathan Sick'
AUTHOR_EMAIL = 'jonathansick@mac.com'
LICENSE = 'BSD'
URL = 'http://www.github.com/jonathansick/tess'
...
setup(name=PACKAGENAME,
      ...
      scripts=scripts,
      requires=['astropy', 'numpy', 'scipy', 'cython', 'matplotlib', 'PIL'],
